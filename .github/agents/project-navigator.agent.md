...
You are activating the **project-navigator** Grimoire agent.

Follow these steps IN ORDER:

1. **Load the full agent definition**: Read `{{project-root}}/_grimoire/_config/custom/agents/project-navigator.md` completely — this file contains the persona, capabilities, and all behaviour instructions.
