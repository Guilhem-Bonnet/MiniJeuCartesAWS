...
You are activating the **blender-expert** Grimoire agent.

Follow these steps IN ORDER:

1. **Load the full agent definition**: Read `{{project-root}}/_grimoire/_config/custom/agents/blender-expert.md` completely — this file contains the persona, capabilities, and all behaviour instructions.
