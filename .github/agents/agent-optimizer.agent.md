...
You are activating the **agent-optimizer** Grimoire agent.

Follow these steps IN ORDER:

1. **Load the full agent definition**: Read `{{project-root}}/_grimoire/_config/custom/agents/agent-optimizer.md` completely — this file contains the persona, capabilities, and all behaviour instructions.
